...
useEffect(() => {
 let q=  data.filter((v) => {
  ...
  function Calculation(e) {
    ...
    if (parsedSalary > 0 && presentDays > 0) {
      if (presentDays <= 30) {
        calculatedSalary = (parsedSalary / 30) * presentDays;
        console.log(calculatedSalary);
        leaveDays = 30 - presentDays;
      } else {
        calculatedSalary = (parsedSalary / 31) * presentDays;
        leaveDays = 31 - presentDays;
      }
    }

    setLeave(leaveDays);
    setSalary(calculatedSalary.toFixed(2)); // Limit to two decimal places
  }
...
{isupdate ? "Update Employee" : " Add Employee"}
      ...
      <Modal.Body>
       <div>
        ...
        <div>
          <label>Rank</label><br/>
          <input type="text" placeholder="Name" value={rank} onChange={(e) => {
        ...
        <div>
          ...
          <input type="number" placeholder="Name" value={g_salary} onChange={(e) => {
        ...
        <div>
          ...
          <input type="number" placeholder="Name" value={Salary} onChange={(e) => {
